...
| A [Toogle](https://github.com/ichim/LeafletForBlazor-NuGet/blob/main/WASM/Components/Toolbar/ToolbarItems/README.md#toggle) is a check/uncheck component that can be hosted in a toolbar.  | ![Toggle](https://raw.githubusercontent.com/ichim/LeafletForBlazor-nuget/main/docs/images/Toggle.png) |

...
| A [Toogle](https://github.com/ichim/LeafletForBlazor-NuGet/tree/main/WASM/Components/Toolbar#toolbar) is a check/uncheck component that can be hosted in a toolbar.  | ![Toggle](https://raw.githubusercontent.com/ichim/LeafletForBlazor-nuget/main/docs/images/Toggle.png) |
